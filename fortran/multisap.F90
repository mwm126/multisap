...
module multi_sweep_and_prune
 ...
 public :: multisap_init, multisap_update, multisap_sort, multisap_quicksort
 public :: multisap_sweep, boxhandle_grow, multisap_update_particle
    ...
    do nn=1, size(new_sap_ids)
       ...
       do mm=1, size(handlelist%list)
          ...
          if (handlelist%list(mm)%sap_id .eq. new_sap_ids(nn)) then
             ...
             if (0.eq.box_id) then
                print *,"box_id is zero for mm=",mm
